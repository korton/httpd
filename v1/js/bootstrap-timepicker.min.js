...
break;case "second":this.decrementSecond();break;case "meridian":this.toggleMeridian()}this.updateElement()}0!==a.keyCode&&(8!==a.keyCode&&9!==a.keyCode&&46!==a.keyCode)&&a.preventDefault()},setValues:function(a){a=a.replace(".",":");if(this.showMeridian){var b=a.split(" "),c=b[0].split(":");this.meridian=b[1]}else c=a.split(":");1==c.length&&(3<=a.length&&4>=a.length)&&(c[1]=(parseInt(c[0],10)%100).toString(),c[0]=(parseInt(c[0],10)/100).toString());this.hour=parseInt(c[0],10);this.minute=parseInt(c[1],
